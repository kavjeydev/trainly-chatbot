...
const colorOptions = ['amber', 'blue', 'green', 'purple', 'red', 'pink', 'indigo', 'cyan', 'teal', 'emerald'];
...
export default function AdminDashboard() {
  ...
  const loadContentSettings = async () => {
    ...
    try {
      ...
      setContentError(error instanceof Error ? error.message : 'Failed to load content settings');
    } finally {
  ...
  const handleSaveContent = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setContentError(error instanceof Error ? error.message : 'Failed to save content settings');
    } finally {
        ...
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-amber-500/60 font-mono">no-code chatbot builder</p>
            </div>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">Customize your chatbot&apos;s appearance and branding</p>
              </div>
              <button
              ...
              >
                <svg className={`w-4 h-4 ${isLoadingBranding ? 'animate-spin' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <form onSubmit={handleSaveBranding} className="space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-medium text-amber-400 uppercase tracking-wider">Company Info</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm text-gray-300">Chatbot Name</label>
                    <input
                      type="text"
                      value={brandingSettings.chatbotName}
                      onChange={(e) => setBrandingSettings({ ...brandingSettings, chatbotName: e.target.value })}
                      className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none transition-colors"
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    onChange={(e) => setBrandingSettings({ ...brandingSettings, description: e.target.value })}
                    rows={2}
              ...
              <div className="space-y-4 pt-4 border-t border-white/10">
                <h3 className="text-sm font-medium text-amber-400 uppercase tracking-wider">Chat Widget</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label className="text-sm text-gray-300">Welcome Message</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-2">
                    <label className="text-sm text-gray-300">Input Placeholder</label>
                    <input
                      type="text"
                      value={brandingSettings.inputPlaceholder}
                      onChange={(e) => setBrandingSettings({ ...brandingSettings, inputPlaceholder: e.target.value })}
                      className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none transition-colors"
                ...
                <div className="space-y-2">
                  <label className="text-sm text-gray-300">Suggested Questions (comma-separated)</label>
                  <input
                    type="text"
                    value={brandingSettings.suggestedQuestions.join(', ')}
                    onChange={(e) => setBrandingSettings({
                      ...brandingSettings,
                      suggestedQuestions: e.target.value.split(',').map(q => q.trim()).filter(Boolean)
                    })}
                    className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none transition-colors"
              ...
              {/* Colors */}
              <div className="space-y-4 pt-4 border-t border-white/10">
                <h3 className="text-sm font-medium text-amber-400 uppercase tracking-wider">Colors</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm text-gray-300">User Message Color</label>
                    <select
                      value={brandingSettings.userMessageColor}
                      onChange={(e) => setBrandingSettings({ ...brandingSettings, userMessageColor: e.target.value })}
                      className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none transition-colors appearance-none cursor-pointer"
                    >
                      {colorOptions.map((color) => (
                        <option key={color} value={color} className="bg-gray-900">{color}</option>
                  ...
                  <div className="space-y-2">
                    <label className="text-sm text-gray-300">Chat Button Color</label>
                    <select
                      value={brandingSettings.chatButtonColor}
                      onChange={(e) => setBrandingSettings({ ...brandingSettings, chatButtonColor: e.target.value })}
                      className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none transition-colors appearance-none cursor-pointer"
                    >
                      {colorOptions.map((color) => (
                        <option key={color} value={color} className="bg-gray-900">{color}</option>
              ...
              <div className="space-y-4 pt-4 border-t border-white/10">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-medium text-amber-400 uppercase tracking-wider">Features (Landing Page)</h3>
                  <button
                    type="button"
                    onClick={() => setBrandingSettings({
                      ...brandingSettings,
                      features: [...brandingSettings.features, { title: '', description: '', icon: 'bolt' }]
                    })}
                ...
                <div className="space-y-3">
                  {brandingSettings.features.map((feature, index) => (
                    <div key={index} className="flex gap-3 items-start bg-black/20 rounded-xl p-4">
                      <select
                        value={feature.icon}
                        onChange={(e) => {
                          const newFeatures = [...brandingSettings.features];
                          newFeatures[index] = { ...feature, icon: e.target.value };
                          setBrandingSettings({ ...brandingSettings, features: newFeatures });
                        }}
                      ...
                      <button
                        type="button"
                        onClick={() => {
                          const newFeatures = brandingSettings.features.filter((_, i) => i !== index);
                          setBrandingSettings({ ...brandingSettings, features: newFeatures });
                        }}
              ...
              {/* Options */}
              <div className="space-y-4 pt-4 border-t border-white/10">
                <h3 className="text-sm font-medium text-amber-400 uppercase tracking-wider">Options</h3>
                <label className="flex items-center gap-3 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={brandingSettings.showPoweredBy}
                    onChange={(e) => setBrandingSettings({ ...brandingSettings, showPoweredBy: e.target.checked })}
                    className="w-5 h-5 rounded bg-white/5 border border-white/20 text-amber-500 focus:ring-amber-500 focus:ring-offset-0"
                  />
                  <span className="text-sm text-gray-300">Show &quot;Powered by Trainly&quot; badge</span>
                </label>
              </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">Edit the text and sections on your landing page</p>
              </div>
              <button
                ...
                className="text-sm text-amber-400 hover:text-amber-300 disabled:opacity-50 flex items-center gap-1"
              >
                <svg className={`w-4 h-4 ${isLoadingContent ? 'animate-spin' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                </svg>
            ...
            <form onSubmit={handleSaveContent} className="space-y-6">
              {/* Hero Section */}
              <div className="space-y-4">
                <h3 className="text-sm font-medium text-amber-400 uppercase tracking-wider">Hero Section</h3>
                <div className="space-y-2">
                  <label className="text-sm text-gray-300">Main Heading</label>
                  <input
                    type="text"
                    value={contentSettings.heroHeading}
                    onChange={(e) => setContentSettings({ ...contentSettings, heroHeading: e.target.value })}
                    className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none transition-colors"
                    placeholder="Intelligent conversations, instant answers"
                  />
                  <p className="text-xs text-gray-500">Tip: Add a comma to highlight the second part in color</p>
                </div>
                <div className="space-y-2">
                  <label className="text-sm text-gray-300">Subheading</label>
                  <textarea
                    value={contentSettings.heroSubheading}
                    onChange={(e) => setContentSettings({ ...contentSettings, heroSubheading: e.target.value })}
                    rows={2}
                    className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none transition-colors resize-none"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={(e) => setContentSettings({ ...contentSettings, heroCtaText: e.target.value })}
                      className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none transition-colors"
                      placeholder="Try it now"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm text-gray-300">CTA Link (optional)</label>
                    <input
                      type="text"
                      value={contentSettings.heroCtaLink}
                      onChange={(e) => setContentSettings({ ...contentSettings, heroCtaLink: e.target.value })}
                      className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none transition-colors"
                      placeholder="https://calendly.com/your-link"
                    />
                    <p className="text-xs text-gray-500">Leave empty to show chat widget pointer instead</p>
                  </div>
                </div>
              </div>
              ...
              {/* Features Section */}
              <div className="space-y-4 pt-4 border-t border-white/10">
                <h3 className="text-sm font-medium text-amber-400 uppercase tracking-wider">Features Section</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label className="text-sm text-gray-300">Section Heading</label>
                    <input
                      type="text"
                      value={contentSettings.featuresHeading}
                      onChange={(e) => setContentSettings({ ...contentSettings, featuresHeading: e.target.value })}
                      className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none transition-colors"
                      placeholder="Why Choose Us"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm text-gray-300">Section Subheading</label>
                    <input
                      type="text"
                      value={contentSettings.featuresSubheading}
                      onChange={(e) => setContentSettings({ ...contentSettings, featuresSubheading: e.target.value })}
                      className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none transition-colors"
                      placeholder="Built with cutting-edge technology..."
                    />
                  </div>
                </div>
                <p className="text-xs text-gray-500">Feature cards are configured in the Branding tab</p>
              </div>

              {/* Bottom CTA */}
              <div className="space-y-4 pt-4 border-t border-white/10">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-medium text-amber-400 uppercase tracking-wider">Bottom Call-to-Action</h3>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={contentSettings.showBottomCta}
                      onChange={(e) => setContentSettings({ ...contentSettings, showBottomCta: e.target.checked })}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          onChange={(e) => setContentSettings({ ...contentSettings, bottomCtaHeading: e.target.value })}
                          className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none transition-colors"
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          onChange={(e) => setContentSettings({ ...contentSettings, bottomCtaDescription: e.target.value })}
                          className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none transition-colors"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          onChange={(e) => setContentSettings({ ...contentSettings, bottomCtaButtonText: e.target.value })}
                          className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none transition-colors"
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          onChange={(e) => setContentSettings({ ...contentSettings, bottomCtaButtonLink: e.target.value })}
                          className="w-full bg-white/5 border border-white/10 focus:border-amber-500/50 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none transition-colors"
                          placeholder="https://calendly.com/your-link"
                        />
                      </div>
              ...
              {/* Footer */}
              <div className="space-y-4 pt-4 border-t border-white/10">
                <h3 className="text-sm font-medium text-amber-400 uppercase tracking-wider">Footer</h3>
                <div className="space-y-2">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">Configure how your chatbot responds</p>
              </div>
              <button
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">Upload documents to train your chatbot</p>
              </div>
              <button
                onClick={loadFiles}
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
            ...
            <div className="mt-6 p-4 bg-white/5 border border-white/10 rounded-xl">
              ...
              <div className="flex flex-wrap gap-2">
                {['WordPress', 'Shopify', 'Webflow', 'Wix', 'Squarespace', 'HTML'].map((platform) => (
                  <span key={platform} className="px-3 py-1 bg-white/5 border border-white/10 rounded-lg text-xs text-gray-300">
                    {platform}
                  </span>
                ))}
              </div>
